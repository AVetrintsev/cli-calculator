...
Short duration symbols are w, d, h, m, s and ms. Russian symbols are н, д, ч, м, с and мс. Days remain 24 hours and weeks remain seven days. Adjacent duration components are added: 1h30m and 1h 30m both equal 90min. Use an explicit * to multiply adjacent duration quantities. This is a special duration rule, not a general rule for adjacent quantities. Component order, repetitions and chains consisting only of ambiguous symbols remain open.
